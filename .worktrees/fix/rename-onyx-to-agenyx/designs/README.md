# Agenyx App — Design Tokens for Google Stitch

> Comprehensive design token documentation for every screen in the Agenyx app.
...
**App:** Agenyx — Local AI Agent Client
...
| --------------- | ---- | ------ | ------------------ |
| `display-md`    | 36px | 400    | App name "Agenyx"    |
...
2. Create a new project for "Agenyx"
