...
export function NotFoundSessionsScreen({
  screenTitle = 'No Active Sessions Yet',
  desc = 'Connect your local repository or start an agent prompt session to begin collaborating with Agenyx.',
  onCreateSession,
  onImportRepository,
  onSelectBlueprint,
    ...
    <Container>
      <SafeAreaView edges={['left', 'right']} className="flex-1">
        ...
        <ScrollView
          ...
          className="max-w-mobile mx-auto w-full py-2">
          ...
          <View className="mb-6 rounded-xl bg-surface-container p-4 shadow-sm">
            ...
            <Text className="mb-3 text-[13px] leading-relaxed text-on-surface-variant">
              Jumpstart your workflow with these contextual prompt blueprints crafted for Agenyx:
            </Text>
